...
export default function RootLayout({
  ...
  <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
    ...
    <nav className="md:ml-auto md:mr-auto flex flex-wrap items-center font-bold lg:gap-5 justify-center">
      ...
      <Link href="/bestPlants" className="mr-5 hover:text-gray-900">Skills</Link>
      <Link href="/benefits" className="mr-5 hover:text-gray-900">experience </Link>
    </nav>
  </div>
</header> */}
